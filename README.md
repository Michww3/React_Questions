...
| №   | Вопрос |
| --- | --- |
| 1 | [Что такое Webpack?](#webpack) |
| 2 | [Что такое Virtual DOM и как он работает?](#что-такое-virtual-dom-и-как-он-работает) |
| 3 | [React: Function Components и Class Components](#react) |
| 4 | [Что такое Props в React?](#props) |
| 5 | [Какие хуки существуют в React?](#какие-хуки-вы-знаете) |
| 6 | [В чем разница между состоянием (State) и Props в React?](#в-чем-разница-между-состоянием-и-пропсами-в-react) |
| 7 | [Что такое условный рендеринг (Conditional Rendering) в React?](#что-такое-условный-рендеринг-в-react) |
| 8 | [Что такое Context в React и для чего он используется?](#что-такое-условный-рендеринг-в-react) |
